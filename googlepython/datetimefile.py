...
#checks the date that the file was modified, and
#returns just the date portion of the timestamp in the format of yyyy-mm-dd.
...
def file_date(filename):
  ...
  tst=datetime.datetime.fromtimestamp(timestamp)
  cc=str(tst)
